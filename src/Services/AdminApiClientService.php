    ...
    */
    ...
    { 
       ...
       if ($orgs["organizations"] == null)
         throw new ApiException ("You must create an organization for this account to use the DocuSign Admin API. \r\n
         For details, see https://support.docusign.com/guides/org-admin-guide", 1);
       else
